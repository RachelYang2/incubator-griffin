...
function(angular, mocks, CreateRuleVACtrl) {
    describe('Test /js/controllers/createrule-va-ctrl.js',
    function() {
        beforeEach(function() {
        ...
        beforeEach(function() {
            $scope = $rootScope.$new();
            controller = $controller('CreateRuleVACtrl', {
                $scope: $scope,
                $route: $route,
                toaster: toaster
            });
        ...
        describe("if the controller of CreateRuleVACtrl exists",
        function() {
        ...
        describe("check if form function are work",
        function() {
