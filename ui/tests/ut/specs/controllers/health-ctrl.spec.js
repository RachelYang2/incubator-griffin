...
define(['require', 'angular', 'angularMocks', 'js/controllers/health-ctrl', 'echarts','js/services/bark-chart'],
  function(require, angular, mocks, HealthCtrl) {
    describe('Test /js/controllers/health-ctrl.js', function(){
        ...
        beforeEach(function(){
          	$scope =  $rootScope.$new();
	        controller = $controller('HealthCtrl', {$scope: $scope, $route: $route, toaster: toaster ,$barkChart:$barkChart });
        });
        ...
        describe("check if parameters are available",function(){
      	...
      	describe("httpGet $config.uri.dashboard test",function(){
	        beforeEach(function(){  
	        	$httpBackend.when('POST', $config.uri.dashboard).respond(
	            	{"hits" : {"hits" : [{"_source" : {"name" : "buy_hourly","tmst" : 1493951823461,"total" : 23224,
          		"matched" : 23028}},{"_source" : {"name" : "search_hourly","tmst" : 1493951823461,"total" : 1067347,"matched" : 1067346}},]}
          		});
