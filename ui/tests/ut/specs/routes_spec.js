...
function(angular, mocks, filter) {
    ...
    function() {
        ...
        function() {
            ...
            it('should load the health page on successful load of/health',
            function() {
        ...
        describe("Measure route",
        function() {
            beforeEach(inject(function($httpBackend) {
                $httpBackend.expectGET('/measures.html').respond(200, 'measures HTML');
            }));
            it('should load the measures page on successful load of/measures',
            function() {
                expect(route.current).toBeUndefined();
        ...
        function() {
            ...
            it('should load the jobs page on successful load of/jobs',
            function() {
                expect(route.current).toBeUndefined();
                location.path('/jobs');
                // expect(route).toBe('...');
